...
def all_reduce(
    ...
    if variant == VARIANT_ATOMIC:
        ...
        if workspace is None or workspace.barrier_flags is None:
            raise RuntimeError("two_shot requires workspace preparation. Call all_reduce_preamble before all_reduce.")
